import { A as AstroError, z as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, B as ExpectedImageOptions, D as ExpectedImage, H as ExpectedNotESMImage, J as resolveSrc, K as isRemoteImage, Q as isRemotePath, T as isESMImportedImage, U as isLocalService, V as DEFAULT_HASH_PROPS, W as InvalidImageService, X as ImageMissingAlt, Y as AstroError$1, Z as InvalidImageService$1, _ as isRemotePath$1, $ as isRemoteAllowed } from '../chunks/astro/assets-service_DNFiBeaP.mjs';
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, e as addAttribute, s as spreadAttributes, f as createAstro } from '../chunks/astro/server_DmdvD1me.mjs';
import 'clsx';
...
async function getConfiguredImageService$1() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_DNFiBeaP.mjs'
    ).then(n => n.a0).catch((e) => {
...
}, "C:/Users/thiag/Porfolio-2024/node_modules/.pnpm/astro@4.16.7_rollup@4.24.3_typescript@5.3.3/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/Users/thiag/Porfolio-2024/node_modules/.pnpm/astro@4.16.7_rollup@4.24.3_typescript@5.3.3/node_modules/astro/components/Picture.astro", void 0);
...
const GET = async ({ request }) => {
  try {
    ...
    const isRemoteImage = isRemotePath$1(transform.src);
